...
まずは試しに「Python」と検索してみましょう。

すると下記の画像のように「Python」の拡張機能が表示されるのでインストールしてください。

![image](https://i.gyazo.com/017f4354e5ea7861b072b3d4f4df798c.jpg)

これでPythonの拡張機能がインストールできました。同じやり方で他の拡張機能もインストールしてみましょう。
