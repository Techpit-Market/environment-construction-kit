...
Cloud9のエディタのインデントはデフォルトで4つになっています。

Rubyのインデントは2つ、PHPのインデントは4つというように、各言語に規約が存在します。

インデントの設定を変更するには、右上の歯車アイコンをクリックし、「Soft Tabs」の箇所の数字を変更しましょう。

![image](https://i.gyazo.com/65e7f88d40d559e8ae4d3ae6ee68d99e.png)


Cloud9の環境構築は以上になります。お疲れ様でした！
